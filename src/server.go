...
func Run() {
	...
	router.GET("/api/instances/:id/files/content", requireSession, instanceFileContent)
	router.PUT("/api/instances/:id/files/content", requireSession, saveInstanceFileContent)
	router.POST("/api/instances/:id/files/upload", requireSession, uploadInstanceFile)
	...
	router.GET("/api/admin/tasks/:id/diagnostic", requireAdmin, adminTaskDiagnosticHandler)
	...
	router.GET("/api/admin/plan-price-tiers", requireAdmin, adminPlanPriceTiers)
	router.POST("/api/admin/plan-price-tiers", requireAdmin, adminSavePlanPriceTier)
	router.PUT("/api/admin/plan-price-tiers/:id", requireAdmin, adminSavePlanPriceTier)
	router.GET("/api/admin/benefit-programs", requireAdmin, adminBenefitPrograms)
	router.POST("/api/admin/benefit-programs", requireAdmin, adminSaveBenefitProgram)
	router.PUT("/api/admin/benefit-programs/:id", requireAdmin, adminSaveBenefitProgram)
	router.POST("/api/admin/benefit-programs/:id/grants", requireAdmin, adminGrantBenefit)
	router.GET("/api/admin/benefit-programs/:id/grants", requireAdmin, adminBenefitGrants)
	router.POST("/api/admin/benefit-programs/:id/grants/:grantID/void", requireAdmin, adminVoidBenefitGrant)
	router.GET("/api/admin/benefit-redemptions", requireAdmin, adminBenefitRedemptions)
	...
	router.POST("/api/admin/tasks/discard-all", requireAdmin, discardAllAdminTasks)
